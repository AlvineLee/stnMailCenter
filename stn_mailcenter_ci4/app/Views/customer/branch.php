    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-blue-600">총 지사 수</p>
        ...
        <div class="bg-green-50 rounded-lg p-4 border border-green-200">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-green-600">총 직원 수</p>
                    <p class="text-2xl font-bold text-green-900">120</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-yellow-600">운영중</p>
        ...
        <div class="bg-purple-50 rounded-lg p-4 border border-purple-200">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-2xl font-bold text-purple-900">₩8.2M</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>광주지사</td>
                    <td>광주</td>
                    <td>광주시 서구 상무대로 789</td>
                    <td>062-345-6789</td>
                    <td>최광주</td>
                    <td><span class="status-badge" style="background: #fef3c7; color: #92400e;">준비중</span></td>
                    <td class="action-buttons">
                        <button>수정</button>
                        <button>상세</button>
                    </td>
