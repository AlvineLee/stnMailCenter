...
<section>
    ...
    <form method="POST" action="/auth/processLogin" style="max-width: 400px; margin: 0 auto;">
        ...
        <button type="submit" style="width: 100%; padding: 12px; background: #dd4814; color: white; border: none; border-radius: 4px; font-size: 16px; cursor: pointer;">
            로그인
        </button>
    </form>

    <div style="margin-top: 20px; padding: 15px; background: #e6f3ff; border-radius: 4px; text-align: center;">
